...
DATA_TRAIN='/private/workspace/cyt/bone_age_assessment/data/RSNA/training' #Path to  images
HEATMAPS_TRAIN=$SAVE_FOLDER"/HEATMAPS_TRAIN" #Path to heatmaps (Will be created automatically)
ANN_PATH_TRAIN='/private/workspace/cyt/bone_age_assessment/data/RSNA/annotations/RSNA_Boneage_Training.csv' #Path to csv annotations
...
DATA_VAL='/private/workspace/cyt/bone_age_assessment/data/RSNA/val' #Path to  images
HEATMAPS_VAL=$SAVE_FOLDER"/HEATMAPS_VAL" #Path to heatmaps (Will be created automatically)
ANN_PATH_VAL='/private/workspace/cyt/bone_age_assessment/data/RSNA/annotations/RSNA_Boneage_Validation.csv' #Path to csv annotations
